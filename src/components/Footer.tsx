            ...
            <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
                ...
                <div className="flex mt-8 flex-col md:flex-row md:justify-between">
                    ...
                    <div className="w-44 pt-6 md:pt-0">
                        <a href="" className="bg-orange-500 justify-center text-center text-black rounded-lg shadow px-10 py-3 flex items-center">Contact
                            US</a>
                    </div>
                </div>
                <div className="flex flex-col">
                    <div className="flex mt-24 mb-12 flex-row justify-between">
                        <a className="hidden md:block cursor-pointer text-white hover:text-orange-500 uppercase">Home</a>
                        <a className="hidden md:block cursor-pointer text-white hover:text-orange-500 uppercase">Internet</a>
                        ...
                        <div className="flex flex-row space-x-8 items-center justify-between">
                            <a href="https://www.facebook.com/pamojahomefiber/">
                            ...
                            <a href="https://www.instagram.com/pamojahomefiber/">
